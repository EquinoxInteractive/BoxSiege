// HealthP2.cs — Updated: isEliminated flag
// File ini menggantikan: HealthP2/HealthP2.cs
...
public class HealthP2 : MonoBehaviour
{
    ...
    [SerializeField] private Health otherPlayerHealth;
    ...
    private void Awake()
    {
        ...
        if (otherPlayerHealth == null) otherPlayerHealth = FindObjectOfType<Health>();

        if (GameData.Instance?.player2Character != null)
            spriteRenderer.sprite = GameData.Instance.player2Character.aliveSprite;
    }
    ...
    public void TakeDamage(float _damage)
    {
        ...
        if (currentHealth <= 0 && !isDead)
        {
            ...
            {
                DisablePlayer(true);
                gameManager?.ReportPlayerDeath(2);
            }
            else
            {
                DisablePlayer(true);
    ...
    public void DisablePlayer(bool showDeathSprite)
    {
        ...
        if (showDeathSprite && spriteRenderer != null &&
            GameData.Instance?.player2Character != null)
            spriteRenderer.sprite = GameData.Instance.player2Character.deathSprite;
    ...
    public void EnablePlayer()
    {
        ...
        if (spriteRenderer != null && GameData.Instance?.player2Character != null)
            spriteRenderer.sprite = GameData.Instance.player2Character.aliveSprite;
