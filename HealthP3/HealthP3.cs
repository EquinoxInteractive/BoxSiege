// HealthP3.cs — Updated: isEliminated flag
// File ini menggantikan: HealthP3/HealthP3.cs

using UnityEngine;
using UnityEngine.InputSystem;

public class HealthP3 : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        if (GameData.Instance?.player3Character != null)
            spriteRenderer.sprite = GameData.Instance.player3Character.aliveSprite;
    }
    ...
    public void TakeDamage(float _damage)
    {
        ...
        if (currentHealth <= 0 && !isDead)
        {
            ...
            {
                DisablePlayer(true);
                gameManager?.ReportPlayerDeath(3);
            }
            else
            {
                DisablePlayer(true);
    ...
    public void DisablePlayer(bool showDeathSprite)
    {
        ...
        if (showDeathSprite && spriteRenderer != null &&
            GameData.Instance?.player3Character != null)
            spriteRenderer.sprite = GameData.Instance.player3Character.deathSprite;
    ...
    public void EnablePlayer()
    {
        ...
        if (spriteRenderer != null && GameData.Instance?.player3Character != null)
            spriteRenderer.sprite = GameData.Instance.player3Character.aliveSprite;
